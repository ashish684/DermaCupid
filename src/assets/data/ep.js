...
const topText = {
  'About Me':
    'Keep it clean. Do not mention your contact details, social media profile, web links here.',
  Religion: 'You can edit this field only once.',
};
  ...
  profile: {
    ...
    Name: [
...

      {
        ...
        component: CustomDropDown,
        data: ['No', 'Yes, living with me', 'Yes, living separately'],
        dropDownPosition: true,
      },
    ],
    Country: [
    ...
    Drink: [
      ...
      },
      {
        ...
        label: 'Diet',
        component: CustomDropDown,
        data: ['Non-vegetarian', 'Vegetarian', 'Eggetarian', 'Vegan'],
      },
    ],
